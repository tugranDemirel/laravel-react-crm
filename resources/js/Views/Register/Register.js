            ...
            <div style={{ width: '100%', height:'100vh'}} className="d-flex align-items-center justify-content-center">
                <form className="form-signin">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="inputEmail" className="form-control" placeholder="Ad Soyad" required="" autoFocus="" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" id="inputPassword" className="form-control" placeholder="Şifre" required="" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="inputPassword" className="sr-only">Şifre Tekrarı</label>
                        <input type="password" id="inputPassword" className="form-control" placeholder="Şifre Tekrarı" required="" />
                    </div>
